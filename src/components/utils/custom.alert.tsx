...
const CustomAlert = () => {
  ...
  return (
    <div
      id="alert-2"
      className="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 my-3 max-w-lg m-auto absolute lg:translate-x-[100%]"
      role="alert"
    >
      <svg
